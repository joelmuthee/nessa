...
3. **ThriftLux** — pre-loved designer bags, the existing catalog at `thriftlux.ke` (her side hustle).
...
| Bags | "ThriftLux Bags" | "Curated pre-loved designer handbags." | `https://thriftlux.ke` (external, new tab) |
